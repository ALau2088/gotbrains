...
class TriviaSub extends Component {
  constructor(props) {
    super(props);
    this.state = {
      triviaQuestions: data.trivias[1].questions,
      question: data.trivias[1].questions[0],
      checked: "",
      prevChecked: "",
      checkedAnswer: "",
      questionsCorrect: 0,
  ...
  nextQuestion = () => {
    ...
    this.setState({
      question: data.trivias[1].questions[newIndex]
    });
  };
