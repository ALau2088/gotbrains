...
class TriviaDiv extends Component {
  constructor(props) {
    super(props);
    this.state = {
      triviaQuestions: data.trivias[3].questions,
      question: data.trivias[3].questions[0],
      checked: '',
      prevChecked: '',
      checkedAnswer: '',
      questionsCorrect: 0,
  ...
  nextQuestion = () => {
    ...
    this.setState({
      question: data.trivias[3].questions[newIndex]
    })
  }
